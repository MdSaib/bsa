...
const FileCreation: React.FC = () => {
    ...
    const [officers] = useState<User[]>([
        { id: '1', username: 'john.doe', fullName: 'John Doe', email: 'john@gov.bd', role: 'OFFICER', departmentId: '1' },
        { id: '2', username: 'jane.smith', fullName: 'Jane Smith', email: 'jane@gov.bd', role: 'OFFICER', departmentId: '2' }
    ]);
    ...
    const handleWorkflowStepChange = (index: number, field: string, value: string) => {
        setFileData(prev => ({
            ...prev,
                        ...
                        {fileData.workflow.map((step, index) => (
                            ...
                            >
                                ...
                                <select
                                    ...
                                    onChange={(e) => handleWorkflowStepChange(index, 'departmentId', e.target.value)}
                                    required
                                >
                                ...
                                <select
                                    ...
                                    onChange={(e) => handleWorkflowStepChange(index, 'officerId', e.target.value)}
                                    required
                                >
                                    <option value="">Select Officer</option>
                                    {officers
                                        .filter(officer => officer.departmentId === step.departmentId)
                                        .map(officer => (
