...
const AdminDashboard: React.FC = () => {
    // Tab management
    const [activeTab, setActiveTab] = useState<'users' | 'departments' | 'settings'>('users');
            ...
            <Table
                ...
                rows={users.map(user => [
                    ...
                    <div className="flex space-x-2">
                        <Button variant="secondary" onClick={() => console.log('Edit user:', user.id)}>
                            Edit
                        </Button>
                        <Button variant="danger" onClick={() => console.log('Delete user:', user.id)}>
                            Delete
                        </Button>
                    </div>
                ])}
        ...
        <Card>
            ...
            <Table
                ...
                rows={departments.map(dept => [
                    ...
                    dept.code,
                    <div className="flex space-x-2">
                        <Button variant="secondary" onClick={() => console.log('Edit department:', dept.id)}>
                            Edit
                        </Button>
                        <Button variant="danger" onClick={() => console.log('Delete department:', dept.id)}>
                            Delete
                        </Button>
                    </div>
                ])}
    ...
    const renderSettings = () => (
        <Card>
            ...
            <div className="space-y-6">
                {/* File Settings */}
                <div>
                    <h3 className="text-sm font-medium text-gray-900 mb-4">File Settings</h3>
