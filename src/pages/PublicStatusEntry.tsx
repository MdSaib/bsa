...
const PublicStatusEntryPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(
        err instanceof Error ? err.message : 'Invalid file number format',
      );
    }
  };
    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-xl text-gray-600">File Status Check</h2>
        </div>
          ...
          <div className="bg-white shadow overflow-hidden sm:rounded-lg">
            <div className="px-4 py-5 sm:p-6">
              <ul className="list-disc pl-5 space-y-2 text-sm text-gray-600">
                ...
                <li>The file number is usually in the format: FILE-YYYY-XXX</li>
                <li>Case sensitivity does not matter</li>
                <li>
